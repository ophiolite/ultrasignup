...
def Finish_proba():
    ...
    + race + '.</p>' + \
    '<p class=\'text-center\'>For Entertainment Purposes Only: All probabilities are conditional on proper training. However, you are a badass even for making it to the start!</p>'
